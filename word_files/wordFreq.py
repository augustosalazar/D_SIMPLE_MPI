...
def topN_palabras_file1_en_otros(dir_path, file1_name="file_1.txt", case_sensitive=False, top_n=10):
    """
    Calcula el top N de palabras de file_1.txt según su frecuencia total
    ...
    # Leer y normalizar palabras de file_1.txt
    ...
    # Recorre todos los .txt exceptuando file_1.txt
...
def main():
    ...
    file1_name = "file_1.txt"                # Archivo base
